...
static std::vector<std::string> s_Preset_print_options{
    ...
    "bridge_angle",
    "external_bridge_grid_enable", "external_bridge_grid_cells_x", "external_bridge_grid_cells_y", "external_bridge_grid_angle_step", "external_bridge_grid_infill_wall_overlap",
