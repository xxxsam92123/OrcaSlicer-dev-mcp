...
public:
    ...
    // Fill boundary using the internal-bridge overlap value, generated by the
    // same PerimeterGenerator offset chain as ordinary infill.
    ExPolygons                  fill_internal_bridge_expolygons;
    // Clean perimeter-derived boundary reserved for external bridge detection.
    ExPolygons                  external_bridge_fill_expolygons;
    // Center lines of the innermost overhang perimeters, used to localize
    // external bridge/infill overlap to the bridge-wall seam.
...
//    Polygons                    bridged;
    ...
    //BBS
    void    make_perimeters(const SurfaceCollection &slices, const LayerRegionPtrs &compatible_regions, SurfaceCollection* fill_surfaces, ExPolygons* fill_no_overlap, ExPolygons* fill_internal_bridge, ExPolygons* external_bridge_fill, Polylines* external_bridge_wall_boundary);
